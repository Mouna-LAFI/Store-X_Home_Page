...
while ($row = mysqli_fetch_array($result)) {
 ...
 echo'<div class= "card">';
    ...
    echo "<img src='images/".$row['image']."' width='300' height='300'>";echo'<br>';
	echo '<a style="color:#FEAC00 ;text-decoration: none;" " href="add_panier.php?id=' . $row['id'] . '"  ><h2><b>Ajouter au panier</b></h2></a>';

    echo'</div >';
echo'</div >';
    
	 echo'<div class= "col" align="left" width="300" height="300" style="color:black ;text-decoration: none;font-weight:bold;" >';
	 echo'<div class= "card1" >';echo'<br>';
...
echo 'Garantie:';echo'&nbsp';echo'&nbsp';echo $row['garantie'];echo'&nbsp'; echo'mois';echo'<br>';	echo'</table>';
